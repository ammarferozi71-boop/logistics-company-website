...
export const metadata: Metadata = {
  ...
  description: "Contact Great Eastern Company for customs clearance, consulting, and freight forwarding services. Located in Karachi, Pakistan. Call +92 21 32277113.",
